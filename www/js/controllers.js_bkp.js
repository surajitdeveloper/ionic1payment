...
//UserService,
.controller('AuthCtrl', function($ionicHistory, $rootScope, $http,$scope, $state, UserService, $cordovaFacebook, $ionicLoading,$ionicScrollDelegate, $ionicSlideBoxDelegate, $timeout, $stateParams){
  $scope.home = function()
  {
    $state.go('app.home');
  }
...
.controller('NameListCtrl', function($state, NameList, $scope, $ionicLoading,$ionicHistory, $timeout, $ionicSlideBoxDelegate, $ionicScrollDelegate){
  $scope.list = [];
  $scope.favlist = [];
  //$scope.students = {};
  //$scope.len;
